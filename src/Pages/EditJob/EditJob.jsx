            ...
            .then(res => {
                if (res.data.modifiedCount) {
                    Swal.fire({
                        position: "center",
                        icon: "success",
                        title: "Your data is been edited sucessfully",
        ...
        <div>
            ...
            <div className="max-w-2xl mx-auto border border-orange-300 rounded-xl p-2 bg-slate-100 shadow-lg shadow-black">
                ...
                <form onSubmit={handleEditJob}>
                    ...
                    <input className="py-3 px-4 my-3 cursor-pointer  bg-indigo-600 hover:bg-indigo-700 text-center w-full rounded-lg text-white transition ease-in duration-200" type="submit" value='Re submit' />
                </form>
            </div>
        </div>
    );
